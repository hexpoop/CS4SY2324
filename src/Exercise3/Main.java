public class Main{
  public static void main(String[] args){
    ...
    Singer Clairo = new Singer("BetterClairo");
    Singer SirChloe = new Singer("Sir Chloe");
    
    Clairo.changeFavSong("yoshi's island");
    Clairo.performForAudience(12);
    Clairo.changeFavSong("ASAP");
    Clairo.performForAudience(10, SirChloe);
    System.out.println(Clairo.totalPerformances());
  }
}
